...
|**`수업 초대 QR`**|**`학생 방 입장(QR)`**|**`학생 출석체크(QR)`**|**`선생님 출석 인증 생성(QR)`**|**`-`**|
|<img src="https://github.com/prography-team8/gwasuwon-ios/blob/master/gwasuwon/images/student-invitation-qr.jpeg?raw=true" width="143" height="300">|<img src="https://github.com/prography-team8/gwasuwon-ios/blob/master/gwasuwon/images/student-enter-class.gif?raw=true" width="143" height="300">|<img src="https://github.com/prography-team8/gwasuwon-ios/blob/master/gwasuwon/images/student-class-attendance.gif?raw=true" width="143" height="300">|<img src="https://github.com/prography-team8/gwasuwon-ios/blob/master/gwasuwon/images/teacher-qr-generator.gif?raw=true" width="143" height="300">|------|
